...
FROM game
JOIN goal
ON (id = matchid AND (team1 = teamid OR team2 = teamid) AND player LIKE 'Mario%');
...
-- 6. To JOIN game with eteam you could use eithergame JOIN eteam ON (team1=eteam.id) or game JOIN eteam ON (team2=eteam.id)
